%% Test script for spline_aplot_dev.m
% Analyze the effect of the parameters C, R and S in different cases.
% In particular, tweak delta, skip and tbreak.

% Load testcurves.m first (or initialize other splines in B-form .
run testcurves.m;
